...
```bash
curl -LO https://github.com/juliojimenez/hash/releases/download/v28/hash-shell-v28-linux-x86_64
chmod +x hash-shell-v28-linux-x86_64
sudo mv hash-shell-v28-linux-x86_64 /usr/local/bin/hash-shell
hash-shell
```
...
```bash
curl -LO https://github.com/juliojimenez/hash/releases/download/v28/hash-shell-v28-linux-aarch64
chmod +x hash-shell-v28-linux-aarch64
sudo mv hash-shell-v28-linux-aarch64 /usr/local/bin/hash-shell
hash-shell
```
...
```bash
fetch https://github.com/juliojimenez/hash/releases/download/v28/hash-shell-v28-freebsd-x86_64
chmod +x hash-shell-v28-freebsd-x86_64
sudo mv hash-shell-v28-freebsd-x86_64 /usr/local/bin/hash-shell
hash-shell
```
...
```bash
fetch https://github.com/juliojimenez/hash/releases/download/v28/hash-shell-v28-freebsd-aarch64
chmod +x hash-shell-v28-freebsd-aarch64
sudo mv hash-shell-v28-freebsd-aarch64 /usr/local/bin/hash-shell
hash-shell
```
...
```bash
curl -LO https://github.com/juliojimenez/hash/releases/download/v28/hash-shell-v28-darwin-arm64
chmod +x hash-shell-v28-darwin-arm64
sudo mv hash-shell-v28-darwin-arm64 /usr/local/bin/hash-shell
```

#### Ubuntu 24.04 (Noble)

```bash
curl -LO https://github.com/juliojimenez/hash/releases/download/v28/hash-shell_28-1~noble_amd64.deb
sudo dpkg -i hash-shell_28-1~noble_amd64.deb
```

#### Ubuntu 22.04 (Jammy)

```bash
curl -LO https://github.com/juliojimenez/hash/releases/download/v28/hash-shell_28-1~jammy_amd64.deb
sudo dpkg -i hash-shell_28-1~jammy_amd64.deb
```

#### Debian Bookworm

```bash
curl -LO https://github.com/juliojimenez/hash/releases/download/v28/hash-shell_28-1~bookworm_amd64.deb
sudo dpkg -i hash-shell_28-1~bookworm_amd64.deb
```
