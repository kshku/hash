...
```bash
curl -LO https://github.com/juliojimenez/hash/releases/download/v18/hash-shell-v18-linux-x86_64
chmod +x hash-shell-v18-linux-x86_64
sudo mv hash-shell-v18-linux-x86_64 /usr/local/bin/hash-shell
hash-shell
```
...
```bash
curl -LO https://github.com/juliojimenez/hash/releases/download/v18/hash-shell-v18-linux-aarch64
chmod +x hash-shell-v18-linux-aarch64
sudo mv hash-shell-v18-linux-aarch64 /usr/local/bin/hash-shell
hash-shell
```
...
```bash
curl -LO https://github.com/juliojimenez/hash/releases/download/v18/hash-shell-v18-darwin-arm64
chmod +x hash-shell-v18-darwin-arm64
sudo mv hash-shell-v18-darwin-arm64 /usr/local/bin/hash-shell
```
